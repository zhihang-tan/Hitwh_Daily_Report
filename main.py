...
def submit(jid, jktoken, todayid):
    ...
    data = {"list": [
        ...
        {"zjlx": 3,"list": [{ "column": "c018", "content": "未被隔离"},
                            {"column": "c019","content": "居家隔离观察（需要医护人员上门核酸采样）"},
                            {"column": "c020", "content": "校外集中隔离点隔离观察"}],
                            "value": [ "c018"]},
        
        {"zjlx": 3, "list": [{"column": "c003", "content": "未接种"}, 
                             {"column": "c004", "content": "已接种第一针"},
                             {"column": "c005", "content": "已接种第二针"},
                             {"column": "c006", "content": "已接种第三针"}], 
                             "value": ["c006"]}, 
        ...
        {"zjlx": 3, "list": [{"column": "c021", "content": "是"}, 
                             {"column": "c022", "content": "否"}],
                              "value": ["c022"]}, 
        
        {"zjlx": 1, "list": [{"column": "c023", "content": ""}], 
                              "value": ""},
        
        {"zjlx": 3, "list": [{"column": "c024", "content": "是"}, 
                             {"column": "c025", "content": "否"}],
                              "value": ["c025"]}, 
        
        {"zjlx": 1, "list": [{"column": "c026", "content": ""}], 
                              "value": ""},
